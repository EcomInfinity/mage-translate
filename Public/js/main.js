(function($) {
		$(function(){
			//click Edit
			 ...
			 // 	var lang_id = $(this).closest('.form-holder').data("id");
			 // 	ajaxFileUpload('Translation/lang_image_add/lang_id/'+lang_id,lang_id);
			 // });
			 //search
	     ...
	     ajaxFileUpload = function (url, callback, failure){
	           $.ajaxFileUpload(
	               {
		                url:url,            
		                secureuri:false,
